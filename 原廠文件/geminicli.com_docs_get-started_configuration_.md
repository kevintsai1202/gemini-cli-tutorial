...
> [v1 Configuration documentation](https://geminicli.com/docs/get-started/configuration-v1).
...
- [Custom sandbox profiles](https://geminicli.com/docs/get-started/configuration/#sandboxing) (e.g.,
...
- **`useWriteTodos`** (boolean):
  ...
  - **Description:** Enable the write\_todos\_list tool.
  - **Default:**`false`
...
[Section titled “Environment Variables & .env Files”](https://geminicli.com/docs/get-started/configuration/#environment-variables--env-files)
