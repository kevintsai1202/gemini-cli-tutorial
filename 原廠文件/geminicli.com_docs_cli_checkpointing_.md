...
[Section titled “Using the Command-Line Flag”](https://geminicli.com/docs/cli/checkpointing/#using-the-command-line-flag)
...
[Section titled “Using the settings.json File”](https://geminicli.com/docs/cli/checkpointing/#using-the-settingsjson-file)
