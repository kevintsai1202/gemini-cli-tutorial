...
title: "Gemini CLI Extensions | Gemini CLI"
---
...
See [getting started docs](https://geminicli.com/docs/extensions/getting-started-extensions) for a guide on
creating your first extension.

See [releasing docs](https://geminicli.com/docs/extensions/extension-releasing) for an advanced guide on setting up
GitHub releases.
...
[`settings.json` file](https://geminicli.com/docs/get-started/configuration). If both an extension
...
Extensions can provide [custom commands](https://geminicli.com/docs/cli/custom-commands) by placing
