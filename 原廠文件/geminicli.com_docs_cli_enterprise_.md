...
title: "Gemini CLI for the Enterprise | Gemini CLI"
---
...
the [Configuration documentation](https://geminicli.com/docs/get-started/configuration).
...
[Model-Context Protocol (MCP) servers](https://geminicli.com/docs/core/tools-api), it is crucial to
...
[Authentication docs](https://geminicli.com/docs/cli/authentication) for more details.
