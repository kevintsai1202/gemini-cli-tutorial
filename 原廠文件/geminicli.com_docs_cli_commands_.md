...
- **`/extensions`**
  - **Description:** Lists all active extensions in the current Gemini CLI
    session. See [Gemini CLI Extensions](https://geminicli.com/docs/extensions).
- **`/help`** (or **`/?`**)
...
- **`/memory`**
  ...
  - **Sub-commands:**
    ...
    - **Note:** For more details on how `GEMINI.md` files contribute to
      ...
      [CLI Configuration documentation](https://geminicli.com/docs/get-started/configuration).
- **`/restore`**
  ...
  - **Note:** Only available if the CLI is invoked with the `--checkpointing`
    option or configured via [settings](https://geminicli.com/docs/get-started/configuration). See
...
please see the dedicated [Custom Commands documentation](https://geminicli.com/docs/cli/custom-commands).
...
[Section titled “Shell mode & passthrough commands (!)”](https://geminicli.com/docs/cli/commands/#shell-mode--passthrough-commands)
