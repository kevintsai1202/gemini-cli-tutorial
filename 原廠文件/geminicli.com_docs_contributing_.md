...
title: "How to Contribute | Gemini CLI"
---
...
the [Integration Tests documentation](https://geminicli.com/docs/integration-tests.md).
...
Our documentation is organized using [sidebar.json](https://geminicli.com/docs/sidebar.json) as the
