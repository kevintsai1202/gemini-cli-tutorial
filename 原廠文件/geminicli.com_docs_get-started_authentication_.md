...
[Section titled “Quick Check: Running in Google Cloud Shell?”](https://geminicli.com/docs/get-started/authentication/#quick-check-running-in-google-cloud-shell)
...
[Section titled “Authenticate in Interactive mode”](https://geminicli.com/docs/get-started/authentication/#authenticate-in-interactive-mode)
...
[Section titled “(Optional) Set your Google Cloud Project”](https://geminicli.com/docs/get-started/authentication/#optional-set-your-google-cloud-project)
...
[Section titled “First: Set required environment variables”](https://geminicli.com/docs/get-started/authentication/#first-set-required-environment-variables)
...
> [Service Account JSON Key](https://geminicli.com/docs/get-started/authentication/#b-vertex-ai-service-account-json-key) or
> [ADC](https://geminicli.com/docs/get-started/authentication/#a-vertex-ai-application-default-credentials-adc-using-gcloud)
> methods instead.
...
[Section titled “Non-interactive mode / headless environments”](https://geminicli.com/docs/get-started/authentication/#non-interactive-mode--headless-environments)
