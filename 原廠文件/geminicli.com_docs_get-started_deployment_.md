---
url: "https://geminicli.com/docs/get-started/deployment/"
title: "Gemini CLI Installation, Execution, and Deployment | Gemini CLI"
---

[Skip to content](https://geminicli.com/docs/get-started/deployment/#_top)
...
Note: This page will be replaced by [installation.md](https://geminicli.com/docs/get-started/installation).
...
[Section titled “How to install and/or run Gemini CLI”](https://geminicli.com/docs/get-started/deployment/#how-to-install-andor-run-gemini-cli)
...
[Section titled “1. Standard installation (recommended for standard users)”](https://geminicli.com/docs/get-started/deployment/#1-standard-installation-recommended-for-standard-users)
...
[Section titled “2. Run in a sandbox (Docker/Podman)”](https://geminicli.com/docs/get-started/deployment/#2-run-in-a-sandbox-dockerpodman)
...
[Section titled “3. Run from source (recommended for Gemini CLI contributors)”](https://geminicli.com/docs/get-started/deployment/#3-run-from-source-recommended-for-gemini-cli-contributors)
...
[Section titled “4. Running the latest Gemini CLI commit from GitHub”](https://geminicli.com/docs/get-started/deployment/#4-running-the-latest-gemini-cli-commit-from-github)
...
[Section titled “Deployment architecture”](https://geminicli.com/docs/get-started/deployment/#deployment-architecture)
...
[Section titled “Release process”](https://geminicli.com/docs/get-started/deployment/#release-process)
