...
title: "Gemini CLI Configuration | Gemini CLI"
---
...
[current Configuration documentation](https://geminicli.com/docs/get-started/configuration).
...
- [Custom sandbox profiles](https://geminicli.com/docs/get-started/configuration-v1/#sandboxing) (e.g.,
...
- **`coreTools`** (array of strings):
  - **Description:** Allows you to specify a list of core tool names that should
    ...
    built-in tools. See [Built-in Tools](https://geminicli.com/docs/core/tools-api#built-in-tools)
...
- **`theme`** (string):
  - **Description:** Sets the visual [theme](https://geminicli.com/docs/cli/themes) for Gemini CLI.
  - **Default:**`"Default"`
...
- **`sandbox`** (boolean or string):
  - **Description:** Controls whether and how to use sandboxing for tool
    ...
    [Sandboxing](https://geminicli.com/docs/get-started/configuration-v1/#sandboxing).
  - **Default:**`false`
  ...
  - **Properties:**
    - **`<SERVER_NAME>`** (object): The server parameters for the named server.
      ...
      - `excludeTools` (array of strings, optional): List of tool names to
        ...
        the model, even if they are exposed by the server. **Note:**`excludeTools` takes precedence over `includeTools` \- if a tool is in
...
- **`telemetry`** (object)
  - **Description:** Configures logging and metrics collection for Gemini CLI.
    For more information, see [Telemetry](https://geminicli.com/docs/cli/telemetry).
...
- **`usageStatisticsEnabled`** (boolean):
  - **Description:** Enables or disables the collection of usage statistics. See
    [Usage Statistics](https://geminicli.com/docs/get-started/configuration-v1/#usage-statistics) for more information.
  - **Default:**`true`
  - **Example:**
...
[Section titled “Environment Variables & .env Files”](https://geminicli.com/docs/get-started/configuration-v1/#environment-variables--env-files)

Environment variables are a common way to configure applications, especially for
sensitive information like API keys or for settings that might change between
environments. For authentication setup, see the
[Authentication documentation](https://geminicli.com/docs/get-started/authentication) which covers all available
...
- **`--telemetry-target`**:
  - Sets the telemetry target. See [telemetry](https://geminicli.com/docs/cli/telemetry) for more
    information.
...
- **`--telemetry-otlp-protocol`**:
  - Sets the OTLP protocol for telemetry (`grpc` or `http`). Defaults to `grpc`.
    See [telemetry](https://geminicli.com/docs/cli/telemetry) for more information.
- **`--telemetry-log-prompts`**:
  - Enables logging of prompts for telemetry. See
    [telemetry](https://geminicli.com/docs/cli/telemetry) for more information.
- **`--checkpointing`**:
  - Enables [checkpointing](https://geminicli.com/docs/cli/checkpointing).
...
see the [Memory Import Processor documentation](https://geminicli.com/docs/core/memport).
- **Commands for Memory Management:**
  ...
  - Use `/memory show` to display the combined instructional context currently
    ...
    AI.
  - See the [Commands documentation](https://geminicli.com/docs/cli/commands#memory) for full details
